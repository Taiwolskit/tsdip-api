...
def upgrade():
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('deleted_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('could_invite', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('org_type', postgresql.ENUM('dance_group', 'studio', name='org_type'), server_default='studio', nullable=False),
    ...
    sa.ForeignKeyConstraint(['approver_id'], ['manager.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['org_id'], ['organization.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('org_id', 'permission_id', name='uq_role_org_id_permission_id')
    )
