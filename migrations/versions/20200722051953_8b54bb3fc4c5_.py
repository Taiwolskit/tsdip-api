...
def upgrade():
    ...
    op.create_table('permission',
                    ...
                    sa.Column('deleted_at', postgresql.TIMESTAMP(),
                              nullable=True),
                    sa.Column('could_invite', sa.Boolean(),
    ...
    op.create_table('event',
                    ...
                    sa.Column('social_id', postgresql.UUID(
                        as_uuid=True), nullable=True),
                    sa.ForeignKeyConstraint(
                        ['org_id'], ['organization.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['social_id'], ['social.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('name')
    ...
    op.create_table('request_member_log',
                    ...
                    sa.Column('accepted_at', postgresql.TIMESTAMP(),
                              nullable=True),
                    sa.ForeignKeyConstraint(
                        ['invitee_id'], ['user.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['inviter_id'], ['user.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['org_id'], ['organization.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('request_org_log',
                    ...
                    sa.Column('approve_at', postgresql.TIMESTAMP(),
                              nullable=True),
                    sa.ForeignKeyConstraint(
                        ['applicant_id'], ['user.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['approver_id'], ['manager.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['org_id'], ['organization.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
