...
Revision ID: 01b4b7b490b1
Revises: 
Create Date: 2019-11-20 15:15:07.635720
...
def upgrade():
    ...
    sa.Column('studio_type', postgresql.ENUM('dance_group', 'studio', name='studio_type'), server_default='studio', nullable=False),
